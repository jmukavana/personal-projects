package com.jamlech.backend.domain.entity;
import com.jamlech.backend.domain.enumeration.TicketValidationMethod;
import com.jamlech.backend.domain.enumeration.TicketValidationStatusEnum;
